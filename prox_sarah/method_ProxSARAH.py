...
def Prox_SARAH(x, y, x_train, y_train, x_test, y_test, LR, LR_COMP, LBD, GAMMA, \
    ...
    with tf.Session() as sess:
        ...
        # modified print by StochasticGnocchiDescent
        
        if verbose:

            print("number of epochs, number of grdients, training loss, test accuracy")
        ...
        while num_epoch < MAX_TOTAL_EPOCH:
            ...
            if log_enable:
                ...
                if verbose:
                    # modified print by StochasticGnocchiDescent
                    print(f"{num_epoch},{num_grad},{train_loss},{test_accuracy}")
